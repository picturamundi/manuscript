...
![](assets/images/script/the-pen-1.svg)

However, I would probably write it like this:

![](assets/images/script/the-pen-2.svg)

In addition to choosing the middle form of the letter `t`, I have also extended the tail of this letter in a way that causes the second word to “sit” on the first. This is the most common way in which words overlap on the horizontal axis, and it can be briefly explained in three points.
